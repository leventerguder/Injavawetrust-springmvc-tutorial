package _10.external.textMessage.controller;
...
import _10.external.textMessage.service.ProductService;
...
public class ProductController {
	...
	public String list(Model model) {
		...
		return "10.external.textMessage.view/productList";
	}
	...
	public ModelAndView listAllProducts() {
		...
		modelAndView.setViewName("10.external.textMessage.view/productList");
		return modelAndView;
	}
	...
	public String getProductById(@RequestParam(required = false, name = "id") String productId, Model model) {
		...
		return "10.external.textMessage.view/productDetail";
	}
