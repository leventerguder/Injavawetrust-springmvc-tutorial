...
import _11.audit.service.ProductService;
import _11.audit.validator.ProductValidator;
...
public class ProductController {
	...
	public String list(Model model) {
		...
		return "11.audit.view/productList";
	}
	...
	public ModelAndView allProducts() {
		...
		modelAndView.setViewName("11.audit.view/productList");
		return modelAndView;
	}
	...
	public String getProductById(@RequestParam("id") String productId, Model model) {
		...
		return "11.audit.view/productDetail";
	}
	...
	public String getAddNewProductForm(@ModelAttribute("newProduct") Product newProduct) {
		...
		return "11.audit.view/addProduct";
	}
